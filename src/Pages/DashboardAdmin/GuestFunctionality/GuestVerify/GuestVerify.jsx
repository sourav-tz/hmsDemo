...
const GuestVerify = () => {
  ...
  return (
    ...
    <div className="relative min-h-screen w-full flex flex-col justify-start py-10 items-center">
              ...
              />
         <h1 className='text-3xl text-[#5F57FF] mt-10 max-md:mt-24 '>Verify Guest Applications</h1>
                      ...
                      <TableRow key={index}>
                        ...
                        <TableCell className="text-center">
                          <Dialog>
                            ...
                            <GuestVerifyDialog className="min-w-fit w-4/5" guest={guest} removeRequest={removeRequest}> </GuestVerifyDialog>
                            </DialogContent>
                          </Dialog> 
                        </TableCell>
                      </TableRow>
