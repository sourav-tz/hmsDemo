...
const GuestVerifyDialog = ({ guest, removeRequest }) => {
  ...
  const acceptGuestApplication = async() =>{
    try {
      const res = await axios({
          method: 'put',
          url: import.meta.env.VITE_BASE_URL + '/guest/acceptApplicationAdmin/' + guest.application_id,
  ...
  const rejectGuestApplication = async() =>{
    try {
      const res = await axios({
          method: 'put',
          url: import.meta.env.VITE_BASE_URL + '/guest/rejectApplicationAdmin/' + guest.application_id,
          withCredentials: true,
