  ...
  return (
    <>
      <div className="flex flex-col items-center w-full bg-gray-100 min-h-screen mx-auto">
        ...
        <Card className="w-11/12 sm:w-3/4 mt-10 mx-4 lg:mx-16">
                            ...
                            <DialogContent className="min-w-fit">
                              <DialogHeader>
                                <DialogTitle className="text-xl">
                                  {"Application ID" + " : " + guest.application_id + " - " + guest.first_name + " " + guest.last_name}
                                </DialogTitle>
                              </DialogHeader>
                              <GuestReferralDialog className="min-w-fit w-full sm:w-4/5" guest={guest} removeRequest={removeRequest} />
                            </DialogContent>
                          </Dialog>
                        </TableCell>
                      </TableRow>
