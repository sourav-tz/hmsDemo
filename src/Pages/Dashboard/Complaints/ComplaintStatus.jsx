...
const ComplaintStatus = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full bg-gray-100 min-h-screen px-4 sm:px-8 mx-auto [@media(min-width:100px)]:py-16 sm:py-10 lg:p-10">
      ...
      <Card className="w-full max-w-4xl mt-10 overflow-x-auto">
        <Table>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {complaint.status === "pending" ? (
                        <Badge className="bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400" variant="outline">
                          In Progress
                        </Badge>
                      ) : complaint.status === "resolved" ? (
                        <Badge className="bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400" variant="outline">
                          Resolved
                        </Badge>
                    ...
                    <TableCell className="text-right">
                      <Button className="bg-blue-700 hover:bg-blue-500" onClick={() => toggleDescription(complaint.complaintId)}>
                      ...
                      <TableCell colSpan={5} className="bg-gray-100 p-4">
                        ...
                        {complaint.comment && complaint.comment !== "null" && (
                          <p style={{ marginTop: "10px" }}>
                            <strong>Response:</strong> {complaint.comment}
                          </p>
                        )}
                      </TableCell>
                    </TableRow>
